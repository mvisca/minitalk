...
/*   Updated: 2023/08/06 20:05:12 by mvisca           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	server_handler(int signum)
{
	...
	// PONER EL LIB_TGT EN MAKEFILE, HACE QUE SEA DEPENDENCIA DEL OBJ PARA QUE SE COMPILE LA LIBRERIA ANTES QUE LOS OBJETOS
	if (signum == SIGUSR1)
